...
This repository contains my QA assessment work, where I performed manual testing, exploratory testing, security testing, regression strategy, and API testing. The goal was to evaluate the application, identify issues, and validate functionality in a simple and structured way.
